...
import SequenceGraphBase from "../base/SequenceGraphBase";
...
import GraphPoint from "../parts/GraphPoint";
import {GraphValue} from "../parts/GraphValue";
import {AxisDirection} from "../parts/AxisDirection";


export default class SequenceGraphSample extends SequenceGraphBase {
  ...
  constructor(__rootDivD3: any) {
    ...
    this.point = new GraphPoint(this.svg);
  }
